...
// TODO: remove db
func (h *a.HttpProductServer) FindAll(w http.ResponseWriter, r *http.Request) {
	filt := expression.Name("Id").AttributeExists()

	expr, err := expression.NewBuilder().WithFilter(filt).Build()
	if err != nil {
		a.handeException(w, "problem...", http.StatusInternalServerError, err)
	}
...
// TODO: remove db
func (h *a.HttpProductServer) FindOne(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
...
// TODO: remove db
func (h *a.HttpProductServer) Create(w http.ResponseWriter, r *http.Request) {
